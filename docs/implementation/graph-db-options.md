...
This project requires a database to store and traverse social graph relationships (follows, likes, authorship, hashtag connections). The choice of graph database affects the query language, Rust driver ecosystem, operational complexity, and learning value of the project.
