...
- Q12 — see [feed-ranking.md §3.7.1](primitive/feed-ranking.md#371-severance-discovery--the-inbound-side) (severance discovery via inbound self-query, trust-weighted reading) and [feed-ranking.md §3.7.2](primitive/feed-ranking.md#372-bot-cluster-identification--auto-detection-from-path-patterns) (auto-detection of bot-bridge nodes via delta-funnel path patterns, with path-length-aware action guidance). Cause identification is the auto-detect's job, complemented by the community posts in §3.7.3.
- Q13 — see [feed-ranking.md §3.7.4](primitive/feed-ranking.md#374-severance-redemption--the-outbound-side) (severer-side redemption surface, delta-funnel check on the redeeming node's outbound) and [feed-ranking.md §3.7.5](primitive/feed-ranking.md#375-self-redemption-posts) (self-redemption posts via the same `bot-defense` hashtag mechanism, surfaced in the severer's "review severed accounts" view).
